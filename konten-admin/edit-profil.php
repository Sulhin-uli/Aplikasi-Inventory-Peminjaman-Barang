...
if (isset($_POST["simpan"])) {
  ...
  if (ubah($_POST) > 0) {
    $berhasil = true;
    //$_SESSION['success'] = '<i>Berhasil Diubah</i>';
    print "<meta http-equiv='refresh' content='1;URL=admin-page.php?menu=edit-profil'  ";
  } else {
    ...
    <div class="table-responsive">
      <form action="" method="post">
        ...
        <div class="form-group">
          ...
          <input autocomplete="off" type="text" class="form-control bg-light border-0 small" value="<?php print $r['nama_user'] ?>" placeholder="<?php print $r['nama_user'] ?>" name="nama" required> <br>
          <label for="">Username:</label>
          <input autocomplete="off" type="text" class="form-control bg-light border-0 small" minlength="8" value="<?php print $r['username'] ?>" name="username" required> <br>
