...
<head>
  ...
  <title>AIPY | Administrator</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <?php
          if ($_GET['menu'] == 'home') {
            include 'konten-admin/konten.php';
          } elseif ($_GET['menu'] == 'logout') {
            session_destroy();
            print "<meta http-equiv='refresh' content='0;URL=index.php'> ";
          } elseif ($_GET['menu'] == 'jenis-barang') {
            include 'konten-admin/jenis-barang.php';
          } elseif ($_GET['menu'] == 'ruangan') {
            include 'konten-admin/ruangan.php';
          } elseif ($_GET['menu'] == 'pegawai') {
            include 'konten-admin/pegawai.php';
          } elseif ($_GET['menu'] == 'barang') {
            include 'konten-admin/barang.php';
          } elseif ($_GET['menu'] == 'laporan') {
            include 'konten-admin/laporan.php';
          } elseif ($_GET['menu'] == 'peminjaman') {
            include 'konten-admin/peminjaman.php';
          } elseif ($_GET['menu'] == 'pengembalian') {
            include 'konten-admin/data-pengembalian.php';
          } elseif ($_GET['menu'] == 'edit-profil') {
            include 'konten-admin/edit-profil.php';
          } elseif ($_GET['menu'] == 'register') {
            include 'konten-admin/register.php';
          } elseif ($_GET['menu'] == 'laporan-peminjaman') {
            include 'konten-admin/laporan-peminjaman.php';
          } elseif ($_GET['menu'] == 'laporan-pengembalian') {
            include 'konten-admin/laporan-pengembalian.php';
          }
          ?>
        </div>
