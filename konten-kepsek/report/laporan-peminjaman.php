...
<table width="625">
    <tr>
        <td class="text2"><center><b>Laporan Peminjaman Barang</b></center></td>
    </tr>
</table>
</table>
...
$sql = mysqli_query($konek,"SELECT * FROM pinjam INNER JOIN inventaris ON pinjam.id_inventaris = inventaris.id_inventaris
                                                INNER JOIN pegawai ON pinjam.id_pegawai = pegawai.id_pegawai where DATE(tanggal_pinjam) between '$tgl_awal' and '$tgl_akhir'");
