...
<table width="625">
    <tr>
        <td class="text2"><center><b>Laporan Pengembalian Barang</b></center></td>
    </tr>
</table>
</table>
...
$sql = mysqli_query($konek, "SELECT * FROM pengembalian INNER JOIN inventaris ON pengembalian.id_inventaris = inventaris.id_inventaris
                                                INNER JOIN pegawai ON pengembalian.id_pegawai = pegawai.id_pegawai where DATE(tanggal_pinjam) between '$tgl_awal' and '$tgl_akhir'");
